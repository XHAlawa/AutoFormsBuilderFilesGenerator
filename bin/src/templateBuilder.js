...
var propsFunctions_1 = require("./templates/propsFunctions");
var templateBuilder = /** @class */ (function () {
    ...
    templateBuilder.prototype.build = function (key, properties) {
        ...
        this.importsManager.import('FormControl, FormArray, FormGroup, FormBuilder, AbstractControl', '@angular/forms');
        ...
        Object.keys(properties).forEach(function (propertyName) {
            ...
            if (property.Property.type == 'array')
                ...
                services.extraScriptManager.append((helpers_1.helpers.tabs + propsFunctions_1.propFunctionsTemplate.getTemplate(propertyName)));
